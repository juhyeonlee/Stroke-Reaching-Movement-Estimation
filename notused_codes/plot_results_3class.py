...
results = np.load('selectktest_3class.npy')
...
for sub_id in subject_id:
    ...
    for ll in range(len(sub_data[sub_id].reach_comp_score)):
        ...
        if sub_data[sub_id].reach_comp_score[ll] == 3: # or sub_data[sub_id].reach_comp_score[ll] == 2:
            compensation_labels.append(2)
        elif sub_data[sub_id].reach_comp_score[ll] == 1 or sub_data[sub_id].reach_comp_score[ll] == 2:
    ...
    for ll in range(len(sub_data[sub_id].retract_comp_score)):
        ...
        if sub_data[sub_id].retract_comp_score[ll] == 3: # or sub_data[sub_id].retract_comp_score[ll] == 2:
            compensation_labels.append(2)
        elif sub_data[sub_id].retract_comp_score[ll] == 1 or sub_data[sub_id].retract_comp_score[ll] == 2:
            compensation_labels.append(1)
        else:
            compensation_labels.append(0)
...
print(compensation_labels.shape, results.shape)
...
ax2.hist(error_dist['10'], bins=np.linspace(1, 21, 21), color='blue', label='normal -> abnormal')
